"""Data ingestion functions for on-demand and batch refresh (V1 Core MVP).

Moved from workers/tasks.py in V1 cleanup.
Used by:
- API endpoints for on-demand refresh
- GitHub Actions for batch refresh
- Discord commands
"""
